  ...
  return (
    <section className="bg-white py-16 px-4">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        {/* Main Headline */}
        <h2 className="font-['Aboreto'] text-[#091124] text-3xl md:text-5xl uppercase font-bold max-w-4xl leading-tight mb-16">
          {t('pgHeadline')}
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left w-full max-w-6xl">
          ...
          <div className="flex flex-col bg-white p-8 md:p-10 rounded-xl shadow-lg border border-gray-100">
            <div className="text-[#091124] mb-6">
              <div className="bg-[#091124] text-white p-3 rounded-md inline-block">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" /></svg>
              </div>
            </div>
            <h3 className="text-[#091124] font-['Aboreto'] font-bold text-xl uppercase mb-4 tracking-wide">
              {t('pgTitle1')}
            </h3>
          ...
          <div className="flex flex-col bg-[#DDE9CD] p-8 md:p-10 rounded-xl shadow-lg border border-transparent">
            <div className="text-[#091124] mb-6 flex items-center">
        ...
        <div className="mt-16">
          <a 
            href="#booking"
            className="border border-[#091124] text-[#091124] bg-transparent font-['Aboreto'] font-bold uppercase tracking-wider px-10 py-5 hover:bg-[#091124] hover:text-white transition-colors duration-300 shadow-sm inline-block rounded"
          >
            {t('makeAppointment')}
          </a>
        </div>
